    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<form name="sub" method="post" action="sub_action.php">
                    <div class="col-lg-4">


                            <div class="form-group">
                                <label>Subject-Name</label>
                                <input class="form-control" name="sub_name">
                            </div>
                   </div>
						
						
                    </div>
                    <button type="submit" class="btn btn-lg btn-success" name="create">Create Subject</button></form>
                </div>
                <!-- /.row -->
