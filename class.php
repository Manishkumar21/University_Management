    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
					...
					<a href="addclasslist.php"><button type="button" class="btn btn-lg btn-default">All Class List</button></a>
                </p><hr><form name="formmm" action="class_action.php" method="post">
                        <div class="row">
                            <div class="col-lg-4">
									<div class="form-group">
                                    <label for="Select">Branch</label>
                                    <select id="Select" class="form-control" name="branch">
						...
						<div class="row">
                            <div class="col-lg-4">
                                    ...
                                    <select id="Select" class="form-control" name="incharge">
						...
						<button type="submit" class="btn btn-lg btn-success" name="allot">Allot Class</button>
						</form>
                    </div>
