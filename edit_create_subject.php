    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<form name="sub" method="post" action="edit_create_subject_action.php?sub_id=<?php echo $fetch['sub_id'] ?>">
                    <div class="col-lg-4">


                            <div class="form-group">
                                <label>Sunject-Name</label>
                                <input class="form-control" name="sub_name" value="<?php echo $fetch['sub_name']; ?>">
                            </div>
                   </div>
