    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					<form name="teach" method="post" action="teacher-action.php">
                    <div class="col-lg-4">


                            <div class="form-group">
                                <label>Teacher Name</label>
                                <input class="form-control" name="t_name">
                            </div>
                   </div>
					<div class="col-lg-4">
									<div class="form-group">
					...
					<div class="col-lg-4">
                                    ...
                                    <select id="Select" class="form-control" name="qualification">
										<option>--Select--</option>
					...
					<div class="col-lg-4">
							...
							<button type="submit" class="btn btn-primary" name="sub5">Submit</button>
                    </div>
					</form>
                </div>
                <!-- /.row -->
