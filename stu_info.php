            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>Show Student's All Information
                            </li>
                        </ol>
                    </div>
                </div>
...
<?php
$sql="select * from student_table order by stud_id ASC";
...
<td><?php echo $fetch['Father_Occupation']; ?></td>
<td><?php echo $fetch['Father_No']; ?></td>
<!--<td><?php echo $fetch['Mother_Name']; ?></td>
<td><?php echo $fetch['Mother_Occupation']; ?></td>
<td><?php echo $fetch['Mother_No']; ?></td>-->
<td><?php echo $fetch['Address']; ?></td>
<td><?php echo $fetch['M_No']; ?></td>
<td><?php echo $fetch['Email']; ?></td>
<td><a href="edit_stu.php?stud_id=<?php echo $fetch['stud_id'] ?>">Edit</td>
<td><a href="delete_stu.php?stud_id=<?php echo $fetch['stud_id'] ?>">Delete</td>
</tr>
<?php
}
?>
