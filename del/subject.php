    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <p>
                   <a href="subject.php"> <button type="button" class="btn btn-lg btn-sucess">Add Subject List</button></a>
                ...
                </p><form name="stu" method="post" action="stu_action.php">
...
<?php
$sql="select * from subject_table order by sub_id ASC";
$execute=mysql_query($sql);
...
<tr>
<td><?php echo $i; ?></td>
<td><?php echo $fetch['sub_name']; ?></td>
<td><a href="edit_create_subject.php?sub_id=<?php echo $fetch['sub_id'] ?>">Edit</td>
<td><a href="delete_subject.php?sub_id=<?php echo $fetch['sub_id'] ?>">Delete</td>
</tr>
<?php
}
?>
