            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <a href="create_subject.php"> <button type="button" class="btn btn-lg btn-default">Create Subject</button></a>
					...
					<a href="allotted_subject.php"><button type="button" class="btn btn-lg btn-sucess">Allotted Subject</button></a>
                </p>
                    </div>
                    <div><hr>
<?php
...
<td><a href="edit_allotted_subject.php?id=<?php echo $fetch['id'] ?>">Edit</td>
<td><a href="delete_allotted_subject.php?id=<?php echo $fetch['id'] ?>">Delete</td>
</tr>
<?php
}
?>
