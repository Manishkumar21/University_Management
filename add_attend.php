                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <font size="3px"><i class="fa fa-desktop"></i> </font>Edit Attendance daily
                            </li>
                        </ol><hr>
                    </div>
                </div>
				<div class="container">
  <table class="table table-bordered table-collapse" style="width:800px;">
      <tr>
        <th>Select Date</th>
        <th>Select Class</th>
      ...
      <tr>
        <td><input type="date" name="date" style="width:250px; height:30px;" value=""></td>
        <td><select name="selct" value=""style="width:280px; height:30px;">>
		<option name="cse" value="">computer science engineering</option>
		...
		<option name="cse" value="">civil</option>
		<option name="cse" value="">mach</option></select></td>
		<td><input type="submit" name="Manage" value="Manage Attendance" style="width:200px; height:30px;"></td>
      </tr>
