            ...
            <div class="container-fluid">
				...
				<div class="row">
                       ...
                       <div class="col-lg-4">
						 <div class="row">
                    <p>
                   <a href="account.php"> <button type="button" class="btn btn-lg btn-default">Add Admin Account</button></a>
					<a href="all_admin_list.php"><button type="button" class="btn btn-lg btn-sucess">All Admin List</button></a>
                </p>
						</div>
						</div></div><hr>
                <!-- /.row -->
...
<?php
$sql="select * from admin_table order by admin_id ASC";
...
<td><a href="edit_stu.php?stud_id=<?php echo $fetch['admin_id'] ?>">Edit</td>
<td><a href="delete_stu.php?stud_id=<?php echo $fetch['admin_id'] ?>">Delete</td>
</tr>
<?php
}
?>
