    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					<form name="stu" method="post" action="stu_action_update.php?stud_id=<?php echo $fetch['stud_id'] ?>">
                    <div class="col-lg-4">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                                <label>Name</label>
                                <input class="form-control" name="S_Name" value="<?php echo $fetch['S_Name']; ?>">
                            </div>
                   </div>
					<div class="col-lg-4">
									<div class="form-group">
					...
					<div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="Father_Name" value="<?php echo $fetch['Father_Name']; ?>">
                            </div>
                    </div>
					<div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="Father_Occupation" value="<?php echo $fetch['Father_Occupation']; ?>">
                            </div>
                    </div>
					<div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="Father_No" value="<?php echo $fetch['Father_No']; ?>">
                            </div>
                    </div>
					<div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="Mother_Name" value="<?php echo $fetch['Mother_Name']; ?>">
                            </div>
                    </div>
					<div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="Mother_Occupation" value="<?php echo $fetch['Mother_Occupation']; ?>">
                            </div>
                    </div>
					<div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="Mother_No" value="<?php echo $fetch['Mother_No']; ?>">
                            </div>
                    </div>
					<div class="col-lg-4">
