            ...
            <div class="container-fluid">
				...
				<div class="row">
                       ...
                       <div class="col-lg-4">
						 <div class="row">
                    <p>
                   <a href="account.php"> <button type="button" class="btn btn-lg btn-sucess">Add Admin Account</button></a>
					<a href="all_admin_list.php"><button type="button" class="btn btn-lg btn-default">All Admin List</button></a>
                </p>
						</div>
						</div></div><hr><form name="account" method="post" action="account_action.php">
						<div class="col-lg-4">
							...
							<button type="submit" class="btn btn-lg btn-success" name="add">Add New Admin</button>
                   </div></form>
